...
<HTML>
	...
	<BODY CLASS = 'principal'>
		...
		<DIV CLASS = 'article' ID = 'parrafo1'>
			Estudio Juridico Franco y Asociados satisface las necesidades de quienes nos consultan nacional
			e internacionalmente, particulares, empresas y profesionales.Contamos con el mejor staff interdisciplinario para atender 
			los temas en los que nos especializamos.
			<P CLASS = 'main' id = 'parrafo2'>Mala Praxis Medica</P>  
			Médicos legistas de todas las especialidades, que brindaran el informe 
